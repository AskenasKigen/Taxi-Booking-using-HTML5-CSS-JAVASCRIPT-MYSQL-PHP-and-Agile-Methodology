            ...
            <ul class="nav navbar-nav navbar-right"><!--navigation-->
                ...
                if(is_logged_in()){
                    ...
                    echo '<li><a href = "index.php">Home</a></li>';
                      echo '<li><a href = "events2.php">Services</a></li>';
                    echo '<li><a href = "locations2.php">Minicab</a></li>';#
                    echo '<li><a href = "booking.php">My Bookings</a></li>';
                    echo '<li><a href = "contact.php">Enquiry</a></li>';
                ...
                //links non database contents. *if logged out
                    ...
                    echo '<li><a href = "contact.php">Enquirys</a></li>';
